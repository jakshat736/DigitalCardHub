...
const DisplayAllGeneratedLinks = () => {
  var theme =useTheme()
  ...
  const matches=useMediaQuery(theme.breakpoints.down(700))
    ...
    const FetchAllCategory = async () => {
      var data = await getData("review/displayalltaglinks");
    ...
    const handleDelete=async(_id)=>{
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            const response= await postData('review/deleteReviewTagLink',formData,true)
...
export default DisplayAllGeneratedLinks
