...
import logo from "../../Digital Card User Interface/UserDashboard/UserAssets/digitallogo.png";
import Avatar from "@mui/material/Avatar";
import photo from "../../../Digital Card Website/Digital Card User Interface/UserDashboard/Themes/ThemeAssets/ankit1.jpg";
import background from "../../Digital Card User Interface/UserDashboard/UserAssets/background.png";
import icon from "../../Digital Card User Interface/UserDashboard/UserAssets/icon.png";
...
import help from "../../Digital Card User Interface/UserDashboard/UserAssets/help.png"
      ...
      >
        ...
        >
          ...
          <Grid sx={{ width: "100%", marginTop: "3%" }}>
            ...
            <Grid sx={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: matches ? '5%' : '3%',marginBottom:'2%' }}>
              <Button
