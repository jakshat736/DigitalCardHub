...
import { Box, Button, Grid, IconButton, InputAdornment, Paper, TextField, Typography, useMediaQuery, useTheme } from "@mui/material";
        ...
        >
          ...
          ><Grid item xs={10} sx={{ mt: -10, }}>
            ...
            <Grid
              ...
              xs={3}
              md={3}
              sx={{ display: data.location == '' ? 'none' : "flex", justifyContent: "center" }}
            >
              <Button
                href={`${data.location}`}
                sx={{
          ...
          <Grid
            container
            spacing={2}
            sx={{ dispaly: "flex", justifyContent: "center",mt:1,ml:{xs:0,md:4} }}
          >
