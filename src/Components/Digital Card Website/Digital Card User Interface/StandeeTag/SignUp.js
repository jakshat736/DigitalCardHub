import { Box, Button, Grid, TextField, Container, Typography, useTheme, useMediaQuery, Dialog, DialogTitle, Divider, DialogContent, DialogContentText, DialogActions, InputAdornment, IconButton } from '@mui/material';
    ...
    const handleSubmit = async () => {
        if (isError == false && verified == true) {
            ...
            if (result.status == 'true') {
                ...
                var result = await postData('standee/customerLogin', formData, true)
                Swal.fire({
                    position: 'center',
                    icon: 'success',
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        navigate('/standeelogin',{state:{id:tagId}})
