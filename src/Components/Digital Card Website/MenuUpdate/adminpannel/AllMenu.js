import { Grid, Button, Divider, Typography, Paper, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, IconButton, Avatar, Card, CardHeader } from '@mui/material';
          ...
          <Card>
            ...
            <Grid container sx={{ width: 400, cursor: 'pointer', padding: 1 }} >
              <Grid item xs={6} sx={{ display: "flex", justifyContent: "center", flexDirection: "column", mt: -5 }}>
                <Typography>{item.dish}</Typography>
