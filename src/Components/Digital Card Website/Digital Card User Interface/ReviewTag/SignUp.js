...
const handleMouseDownPassword = () => setShowPassword(!showPassword);
            ...
            if (result.status == 'true') {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        navigate('/reviewlogin',{state:{id:tagId}})
    ...
    const hadleopenotpdailog=async()=>{
     ...
     let res=await postData('review/sendOtp',formData,true)
                    ...
                    <Grid container spacing={0}>
                        ...
                        <Grid item xs={12} lg={5} sx={{ p: { xs: "14% 5%", lg: "3% 5%" } }}>
                            ...
                            <Grid container spacing={2} sx={{ p: "8% 5%" }}>
                                ...
                                <Grid item xs={12}>
                                    OTP not received ? <a style={{ cursor: 'pointer' }} onClick={hadleopenotpdailog}>Resend</a>
                                </Grid>
                                <Grid item xs={12}>
                                ...
                                <Grid item xs={12} sx={{ display: "flex", flexDirection: "row", alignItems: "center", mt: "1%" }}>
                                    ...
                                    &nbsp;&nbsp;
                                    <Typography onClick={() =>  navigate('/reviewlogin',{state:{id:tagId}})} sx={{ fontSize: "0.8em", color: "#001E3C", fontFamily: "OXANIUM", fontWeight: 600, textAlign: "center", '&:hover': { color: "red" }, cursor: "pointer" }}>
                                        Log in Now
                                    </Typography>
                                </Grid>
                            </Grid>
