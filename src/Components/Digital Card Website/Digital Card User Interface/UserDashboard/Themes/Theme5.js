    ...
    <Box bgcolor={"#ab9cc9"}>
      ...
      >
        ...
        {data.coverVideo != '' ? <>
                ...
                id="hero"
                    src={ 'data:image/jpeg;base64,' +arrayBufferToBase64(data.companyCoverImage.data.data)}
             height={370}
                /> </>}
        <Box
          bgcolor={"#654E92"}
        ...
        >
          ...
          <Grid
            container
            spacing={2}
            sx={{ dispaly: "flex", justifyContent: "center",mt:-5,mb:5,ml:{xs:0,md:8} }}
          >
