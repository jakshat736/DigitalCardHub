...
import fourboxicon from "../Themes/ThemeAssets/fourbox.png"
...
const actions = [
  { icon: <CallIcon style={{ fontSize: '26px' }} />, name: "Copy" },
            ...
            <Grid sx={{ display: 'flex', marginTop: '-5%', flexDirection: 'column', marginLeft: '4%' }}>
              ...
              <Grid sx={{ marginTop: '3%', marginLeft: '1%' }}>
                <Grid onClick={handleClickSeeMore} sx={{ display: 'flex', flexDirection: 'row', color: '#4A4A4A', cursor: 'pointer' }}>
                  <Grid sx={{ fontSize: 13 }}>See More</Grid><Grid ><KeyboardArrowRightIcon style={{ fontSize: "16px", marginLeft: '2%', }}/></Grid>
                </Grid>
              </Grid>
            </Grid>
          </Grid>)
              ...
              <Grid style={{ display: "flex", flexDirection: "row" }}>
                ...
                >
                  <SpeedDial
                    ...
                    icon={
                      <img src={fourboxicon} style={{width:'54%'}}></img>
                    }
                  >
                    {actions.map((action) => (
                      <SpeedDialAction
