...
export default function Navbar() {
        ...
        return (
                <Box sx={{ flexGrow: 1 }}>
                        <AppBar position="fixed" sx={{ background: "rgba(0, 00, 00,0.3)", boxShadow: "none", color: "black", display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                                <Container maxWidth="xl" sx={{ background: "transparent", boxShadow: "none", color: "black", display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                                        ...
                                        <Toolbar>
                                                <Button sx={{ display: { xs: "none", md: "block" }, color: "#fff", fontSize: "1em", fontFamily: "Oxanium", letterSpacing: "0.1em", fontWeight: 600, m: "0px 5px" }} onClick={() => navigate("/")}>Home</Button>
                                                <Button onClick={() => navigate("/compatible-devices")} sx={{ display: { xs: "none", md: "block" }, color: "#fff", fontSize: "1em", fontFamily: "Oxanium", letterSpacing: "0.1em", fontWeight: 600, m: "0px 5px" }}>Compatible Devices</Button>
