import {  useMediaQuery, Button, Divider, Grid, Dialog, Paper, InputBase, IconButton, RadioGroup, FormControlLabel, Chip } from "@mui/material";
import Navbar from "../UserComponents/Navbar";
import eye1 from "../../../Digital Card Assets/eye1.png"
import share from "../../../Digital Card Assets/share1.png"
import google from "../../../Digital Card Assets/google1.png"
import addsign from "../../../Digital Card Assets/addsign.png"
import rate from "../../../Digital Card Assets/rate.png"
import p1 from "../../../Digital Card Assets/p1.png"
import p2 from "../../../Digital Card Assets/p2.png"
import p3 from "../../../Digital Card Assets/p3.png"
import p4 from "../../../Digital Card Assets/p4.png"
import p5 from "../../../Digital Card Assets/p5.png"
import a1 from "../../../Digital Card Assets/a1.png"
import a2 from "../../../Digital Card Assets/a2.png"
import a3 from "../../../Digital Card Assets/a3.png"
import liness from "../../../Digital Card Assets/line2.png"
import line3 from "../../../Digital Card Assets/line3.png"
...
{     
    ...
    const handleBussiness=()=>{
      navigate('/newbussinessdashboard1')
    }
    ...
    const [profile,setAllProfile]= useState(false)
    ...
    const handleAllProfile = () => {
      setAllProfile(true);
    };
    const handleCloseAllProfile = () => {
      setAllProfile(false);
    };
      ...
      const AllProfile = () => {
        return (
          <Dialog
            ...
            open={profile}
            onClose={handleCloseAllProfile}
            aria-labelledby="alert-dialog-title"
            aria-describedby="alert-dialog-description"
          >
            <Grid sx={{ width: '100%',color:'#000',overflow:'scroll',scrollbarWidth:'none'}}>
            <Grid sx={{ width: '100%', height: 60, display: 'flex', justifyContent: 'center', alignItems: 'center', background: '#131313' }}>
                  <Grid sx={{ fontSize: matches ? '20px' : '24px', fontWeight: 500, lineHeight: '36px', color: '#fff', marginLeft: '2%', marginTop: '-.5%' }}>Select profile</Grid>
                  <Grid onClick={handleCloseAllProfile}
                    aria-label="close"
                    sx={{
                      position: "absolute",
                      right: 10,
                ...
                <Grid sx={{display:'flex',fontFamily: 'poppins',flexDirection:'column',height:'100%',width:'100%',padding:2.5,background:'#fff'}}>
                 <Grid sx={{width:'100%',marginTop:'4%',height:'auto',borderRadius:'10px',flexDirection:'column',background:'#D9D9D9',display:'flex',justifyContent:'center',alignItems:'center',padding:1}}>
                 <Grid>
                  <img src={p1} width={40}></img>
                  </Grid>
                  <Grid sx={{fontSize:'14px',fontWeight:700,marginTop:'1%'}}>
                  Minimal profile
                  </Grid>
                  <Grid sx={{fontSize:'10px',fontWeight:400,marginTop:'1%',width:'80%',textAlign:'center'}}>
                  Visit your activated review profile and make make your business easy
                  </Grid>
                 </Grid>
        ...
        return (
          ...
          >
            ...
            <Grid sx={{ width: '100%',  display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                  <Grid onClick={handleCloseDefault}
                    aria-label="close"
                    sx={{
                      position: "absolute",
                      right: 10,
                ...
                <Grid sx={{display:'flex',justifyContent:'center',alignItems:'center',fontFamily: 'poppins',flexDirection:'column',height:'100%',color:'#000',width:'100%',padding:2.5,background:'#f5f6fa'}}>
                 <Grid sx={{fontSize:'32px',fontWeight:600,width:'60%',textAlign:'center'}}>
                    Hello
                 </Grid>
                 <Grid sx={{fontSize:'32px',fontWeight:600,textAlign:'center',marginTop:'-2%'}}>
                 Harshit Jain
                 </Grid>

                 <Grid sx={{fontSize:'18px',fontWeight:400,width:'80%',textAlign:'center',marginTop:'2%'}}>
                 Click on start to make your vehicle tag profile. 
                 </Grid>

               <Grid sx={{display:'flex',alignItems:'center',gap:2,marginTop:'2%'}}>
                 <img src={line3} style={{width:'100%'}}></img> <div style={{fontSize:'16px',fontWeight:600}}>Or</div>
                 <img src={line3} style={{width:'100%'}}></img>
               </Grid>

               <Grid sx={{fontSize:'18px',fontWeight:400,width:'80%',textAlign:'center',marginTop:'2%'}}>
                Click on<b> “add profile”</b> make your first profile with Digital card hub
                 </Grid>
      ...
      const LoginPin = () => {
        return (
          ...
          >
            <Grid sx={{ width: '100%',color:'#000'}}>
            <Grid sx={{ width: '100%', height: 60, display: 'flex', justifyContent: 'center', alignItems: 'center', background: '#131313' }}>
                  <Grid sx={{ fontSize: matches ? '20px' : '24px', fontWeight: 500, lineHeight: '36px', color: '#fff', marginLeft: '2%', marginTop: '-.5%' }}>Set Login Pin</Grid>
                  <Grid onClick={handleClosePin}
                    aria-label="close"
                    sx={{
                      position: "absolute",
                      right: 10,
                ...
                <Grid sx={{display: 'flex', justifyContent: 'center',padding:2,color:'#000', marginTop:'2%', alignItems: 'center',flexDirection:'column',background:'#f5f6fa'}}>
               <Grid sx={{fontSize:'12x',fontWeight:400,textAlign:'center'}}>
               Set or change your login pin to directly log in with your account without any OTP.
               </Grid>
               <Grid sx={{marginTop:'2%'}}>
              <img src={liness} style={{width:'100%'}}></img>
               </Grid>
               <Grid sx={{fontSize:'18px',fontWeight:600,textAlign:'center',marginTop:'2%',color:'#666666'}}>
               Current Pin number
               </Grid>
               <Grid sx={{width:'100%',marginTop:'2%',fontSize:'22px',fontWeight:600,height:50,borderRadius:'10px',background:"#D3D3D3",color:'#666666',display:'flex',alignItems:'center',justifyContent:'space-around'}}>
                 <Grid>4</Grid><Grid>2</Grid><Grid>8</Grid><Grid>6</Grid>
               </Grid>
               <Grid sx={{fontSize:'18px',fontWeight:600,textAlign:'center',marginTop:'4%'}}>
               New Pin number
               </Grid>
               <Grid
                sx={{
...
<Grid sx={{display:'flex',alignItems:'center',width:'100%',gap:2,marginTop:'3%'}}>
 <Button
                      style={{
                        border: '1px solid #000',
                        borderColor: '#000',
                        height: matchesB ? 40 : '2.7vw',
                        color: "#fff",
...
>
  ...
  >
    ...
    <Grid item xs={12}>
      ...
      >
     <Grid sx={{fontSize:'24px',fontWeight:600}}>Dashboard</Grid>
     <Grid sx={{border:'1px solid #fff',borderRadius:'12px',padding:matches2?2:4,marginTop:'2%',height:'auto',width:'100%',boxShadow: "0px 0px 10px 3px rgba(255, 255, 255, 0.2)",}}>
      <Grid sx={{display:'flex',width:'100%'}}>
      <Grid sx={{width:'60%'}}>
      <Grid sx={{fontSize:'10px',fontWeight:400}}>
      NAME
      </Grid>
      <Grid sx={{fontSize:'18px',fontWeight:600,marginTop:'2%'}}>
      Chinmay sharma
      </Grid>

      <Grid sx={{fontSize:'10px',fontWeight:400,marginTop:'7%'}}>
      MOBILE
      </Grid>
      <Grid sx={{fontSize:'18px',fontWeight:600,marginTop:'2%'}}>
      +91 9179109464
      ...
      <Grid sx={{fontSize:'18px',fontWeight:600,marginTop:'2%',display:'flex',alignItems:'center',gap:2}}>
      <Grid>* * * *</Grid><Grid><img src={eye1} width={20} style={{marginTop:'-5%'}}></img></Grid>
      </Grid>
      ...
      <Grid sx={{width:'40%'}}>
        <Grid sx={{width:"100%",display:'flex'}}>
          <img src={share} width={30} style={{marginLeft:'auto'}} ></img>
        </Grid>
        <Grid onClick={handleDefault} sx={{width:'100%',display:'flex',justifyContent:'center',alignItems:"center"}}>
        <Avatar
                  fullWidth
                  alt="Remy Sharp"
                  sx={{ width: matches ? 70 : '6vw', height: matches ? 70 : '6vw', marginTop: "10%" }}
          />
        </Grid>
      </Grid>
      </Grid>
    ...
    <Grid item xs={12}>
       <Grid
          ...
          >
            <Grid sx={{ boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.2)',width:'100%',display:"flex" ,borderRadius:'6px',}}>
            <Button
            onClick={handleProfile}
              style={{
                border:'1px solid #fff',
                background: Profile?'#fff':"#000",
                color: Profile?'#000':"#fff",
                width: "100%",
                height: "35px",
                fontWeight: 500,
                fontSize: "14px",
       ...
       {Profile ? (
            ...
            <Grid container sx={{marginBottom:matches2?'7%':'4%'}} >
            <Grid
             sx={{padding:2.5}}
              item
              xs={6}
              md={6}
            >
              <Grid sx={{border:'1px solid #fff',flexDirection:'column',background:'#D9D9D9',color:'#000',borderRadius:'10px',width:'100%',height:matches1?180:200,padding:matches2?1:2,display:'flex',justifyContent:'center',alignItems:'center'}}>
                <Grid>
                 <img src={google} width={30}></img>
                </Grid>
                <Grid sx={{marginTop:'2%'}}>
                 <img src={rate} width={70}></img>
                </Grid>
                <Grid sx={{marginTop:'2%',fontSize:matches2?'12px':'15px',fontWeight:700,textAlign:'center'}}>
                 Direct Tag profile
                </Grid>
                <Grid sx={{marginTop:'2%',fontSize:matches2?'10px':'12px',fontWeight:400,textAlign:'center'}}>
                Visit your activated review profile and make make your business easy
                </Grid>
                <Button
               style={{
                border:'1px solid #000',
                marginTop:matches2?'4%':'3%',
                background:"#000",
                color: "#fff",
                fontWeight: matches2?400:500,
                width: "100%",
                height:matches2?'30px':"35px",
                fontSize: "14px",
                textTransform: "none",
                borderRadius: '4px',
                display: "flex",
 ...
 <Grid
             sx={{padding:2.5}}
              ...
              md={6}
            >
              <Grid onClick={handleBussiness} sx={{border:'1px solid #fff',flexDirection:'column',background:'#D9D9D9',color:'#000',borderRadius:'10px',width:'100%',height:matches1?180:200,padding:matches2?1:2,display:'flex',justifyContent:'center',alignItems:'center'}}>
                <Grid>
                 <img src={p2} width={30}></img>
                </Grid>
                <Grid sx={{marginTop:'2%'}}>
                 <img src={rate} width={70}></img>
                </Grid>
 ...
 <Grid
            ...
            >
             ...
             sx={{padding:2.5}}
              ...
              md={6}
            >
              <Grid onClick={handleAllProfile} sx={{border:'1px solid #fff',cursor:'pointer',flexDirection:'column',color:'#fff',borderRadius:'10px',width:'100%',height:matches1?180:200,padding:matches2?1:2,display:'flex',justifyContent:'center',alignItems:'center'}}>
                <Grid>
                 <img src={addsign} width={matches2?60:80}></img>
                </Grid>
                <Grid sx={{marginTop:'3%',fontSize:matches2?'12px':'15px',fontWeight:400,textAlign:'center'}}>
                Add more profiles
                </Grid>
              </Grid>
              </Grid>
              ...
              <>
           <Grid sx={{padding:2.5,width:'100%',marginBottom:'6%'}}>
           <Grid sx={{display:'flex',alignItems:'center'}}>
             <Grid>
           <img src={a1} width={40}></img>
             </Grid>
             <Grid sx={{fontSize:matches2?'20px':'22px',fontWeight:500,marginLeft:'5%'}}>
             Edit default profile
           </Grid>  
            </Grid>

            <Grid sx={{display:'flex',alignItems:'center',marginTop:'4%',cursor:'pointer'}}>
             <Grid>
           <img src={a2} width={40}></img>
             </Grid>
             <Grid onClick={handlePin} sx={{fontSize:matches2?'20px':'22px',fontWeight:500,marginLeft:'5%'}}>
             Set login pin
           </Grid>  
            </Grid>
           ...
           <img src={a3} width={40}></img>
            ...
            <Grid sx={{width:'100%',display:'flex',justifyContent:'center',alignItems:'center',marginTop:'4%'}}>
              <img src={liness} style={{width:'100%'}}></img>
            </Grid>
            <Grid sx={{width:'100%',display:'flex',justifyContent:'center',gap:4,alignItems:'center',marginTop:'4%'}}>
            <Grid sx={{fontSize:matches2?'14px':'16px',fontWeight:500}} >Deactivate your Account</Grid>
            <Grid>
            <Button
               style={{
                border:'1px solid #fff',
          ...
          <Grid sx={{display:'flex',justifyContent:'center',alignItems:'center',width:'100%',marginBottom:'2%'}}>
          <Grid sx={{fontSize:'16px',fontWeight:600,display:'flex'}}>
