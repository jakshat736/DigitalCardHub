...
export default function VehicalSuccess()
{
    ...
    return(<Grid sx={{width:'100%',height:'100vh',backgroundImage:"linear-gradient(to bottom right, #171717,#171717,#070707,#070707)",fontFamily:'Montserrat'}}>
        ...
        <Grid sx={{display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center',width:'100%'}}>
            <Grid sx={{width:'80%',display:'flex',justifyContent:'center',alignItems:'center',flexDirection:'column',height:'auto',border:'1px solid #BEAB00',background:'#E8E8E8',borderRadius:'10px',marginTop:matchesB?'12px':'2.5%',color:'#000',padding:2}}>
                <Grid>
                ...
                <Grid sx={{fontSize:matches?'14px':"18px",fontWeight:500,color:'#000',marginTop:matchesB?'6%':'2%',lineHeight:matchesB?'26px':'36px'}}>
                We have enabled the calling feature on your tag, you can go to dashboard and manage your tag.
                </Grid>

                <Grid sx={{marginTop:matchesB?'8%':'2%',width:'100%',display:'flex',justifyContent:'center',alignItems:'center'}}>
                ...
                <Grid sx={{marginTop:matchesB?'9%':'2%',width:'100%',display:'flex',justifyContent:'center',alignItems:'center'}}>
                ...
                <Grid sx={{fontSize:matches?'14px':"18px",fontWeight:500,color:'#000',marginTop:matchesB?'8%':'2%',lineHeight:matchesB?'26px':'36px'}}>
            ...
            <Grid sx={{marginTop:matchesB?'6%':'1%',fontSize:'14px',fontWeight:300,color:'#fff'}}>
