      ...
      <>
        <Grid
          ...
          sx={{
            ...
            display: data.hotelLink1 != '' ? "flex" : "none",
        ...
        <Grid
          ...
          sx={{
            ...
            display: data.hotelLink2 != '' ? "flex" : "none",
            justifyContent: "flex-start",
            cursor: "pointer",
          }}
        ...
        <Grid
          ...
          sx={{
            marginTop: { xs: 1, sm: 1, md: 1 },
            display: data.hotelLink3 != '' ? "flex" : "none",
            justifyContent: "flex-start",
            cursor: "pointer",
          }}
        ...
        <Grid
          ...
          sx={{
            marginTop: { xs: 1, sm: 1, md: 1 },
            display: data.hotelLink4 != '' ? "flex" : "none",
            justifyContent: "flex-start",
            cursor: "pointer",
          }}
      ...
      >
        ...
        >
          ...
          <Grid
            container
            spacing={2}
            sx={{ dispaly: "flex", justifyContent: "center", flexDirection: "row" }}
          >
            <Grid
              item
              xs={12}
