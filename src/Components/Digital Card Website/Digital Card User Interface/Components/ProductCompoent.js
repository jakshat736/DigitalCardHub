import { Avatar, Box, Grid, IconButton, Paper, Typography, Button, TextField, DialogActions, DialogContent, DialogTitle, Dialog } from '@mui/material'
...
const ProductCompoent = () => {
  ...
  const handleSubmit=async()=>{
    ...
    if (result.status) {
        ...
        window.localStorage.setItem("UserEmail",result.data.emailId)
            // Swal.fire({
            //         position: 'center',
            //         icon: 'success',
          ...
          >
            {data.images.map((item) => (
              ...
              <TextField
                ...
                sx={{marginTop:1,marginBottom:1, bgcolor:"white", 
                ...
                "& label": { paddingLeft: (theme) => theme.spacing(2),color:'#000' ,
                 '&.Mui-focused': {
            ...
            <Grid item xs={12} sx={{ display: "flex", fontSize: 30,justifyContent:"center" }}>
                ...
                <Grid container spacing={2} sx={{ display: "flex", justifyContent: "center" }}>
                        ...
                        <Grid item xs={12}>
                            <Typography sx={{ fontSize: 18, color: "#fff", textAlign: 'center', }}>{data.description}</Typography>
                        </Grid>
                        <Grid item xs={12}>
                            <Typography sx={{ fontSize: 18, color: "#fff", textAlign: 'center' }}>{data.description1}</Typography>
                        </Grid>
                        <Grid item xs={12}>
                        <Typography sx={{ fontSize: 18, color: "#fff", textAlign: 'center' }}>{data.description2}</Typography>
                        </Grid>
                        <Grid item xs={12}>
                        <Typography sx={{ fontSize: 18, color: "#fff", textAlign: 'center' }}>{data.description3}</Typography>
                        </Grid>
                        <Grid item xs={12}>
                        <Typography sx={{ fontSize: 18, color: "#fff", textAlign: 'center' }}>{data.description4}</Typography>
                        </Grid>
                        </Grid>
